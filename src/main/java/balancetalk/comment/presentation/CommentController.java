...
public class CommentController {
    ...
    public void createComment(@PathVariable Long talkPickId, @Valid @RequestBody CommentDto.Request request) {
    ...
    public void updateComment(@PathVariable Long commentId, @PathVariable Long talkPickId, @RequestBody CommentDto.UpdateRequest request) {
    ...
    public void createReply(@PathVariable Long commentId, @PathVariable Long talkPickId,
